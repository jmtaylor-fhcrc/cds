...
Ext.define('Connector.component.Started', {
    ...
    tpl: new Ext.XTemplate(
            ...
            '>',
                ...
                '<tr>',
                    '<td>',
                    '<button class="tour-button next tour-section-button bottom-spacer" onclick="LABKEY.help.Tour.showFromDb(\'111\', 0)">Learn-about</button>',
                    '</td>',
                    '<td>',
                    '<button class="tour-button next tour-section-button bottom-spacer" onclick="LABKEY.help.Tour.showFromDb(\'111\', 0)">Find-subjects</button>',
                    '</td>',
                    '<td>',
                    '<button class="tour-button next tour-section-button bottom-spacer" onclick="LABKEY.help.Tour.showFromDb(\'111\', 0)">Find-subjects</button>',
                    '</td>',
